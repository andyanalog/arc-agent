...
// .wrangler/tmp/bundle-aQPT4c/checked-fetch.js
...
async function verifyCode(env, phoneNumber, workflowId, code) {
...
async function sendMoney(env, phoneNumber, amount, recipient) {
...
__name(sendMoney, "sendMoney");
async function checkBalance(env, phoneNumber) {
...
async function getTransactionHistory(env, phoneNumber, limit = 10) {
...
__name(getTransactionHistory, "getTransactionHistory");
async function confirmAction(env, phoneNumber, workflowId) {
...
async function cancelAction(env, phoneNumber, workflowId) {
...
__name(cancelAction, "cancelAction");
...
Be helpful and concise. Don't explain your tool calls to the user.`
    ...
    let result = await c.env.AI.run("@cf/meta/llama-3.1-8b-instruct", {
      messages,
      tools
    });
...
// ../../../../../../AppData/Local/nvm/v24.4.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../../../../AppData/Local/nvm/v24.4.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../../../../../../AppData/Local/nvm/v24.4.0/node_modules/wrangler/templates/middleware/common.ts
